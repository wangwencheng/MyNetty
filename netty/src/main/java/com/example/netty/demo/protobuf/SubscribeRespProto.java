...
public final class SubscribeRespProto {
  ...
  public interface SubscribeRespOrBuilder extends
     ...
     * @return Whether the subRespCode field is set.
     */
    boolean hasSubRespCode();
    /**
     * <code>required int32 subRespCode = 2;</code>
     * @return The subRespCode.
     */
    int getSubRespCode();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final Object obj) {
      ...
      if (hasSubRespCode() != other.hasSubRespCode()) return false;
      if (hasSubRespCode()) {
        if (getSubRespCode()
            != other.getSubRespCode()) return false;
      }
    ...
    public static final class Builder extends
      ...
      // Construct using com.example.netty.demo.protobuf.SubscribeRespProto.SubscribeResp.newBuilder()
      private Builder() {
      ...
      /**
       * <code>required int32 subRespCode = 2;</code>
       * @param value The subRespCode to set.
       * @return This builder for chaining.
       */
  ...
  static {
    String[] descriptorData = {
      "\n\023SubscribeResp.proto\"D\n\rSubscribeResp\022\020" +
      "\n\010subReqId\030\001 \002(\005\022\023\n\013subRespCode\030\002 \002(\005\022\014\n" +
      "\004desc\030\003 \002(\tB5\n\037com.example.netty.demo.pr" +
